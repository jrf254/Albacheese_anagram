...
AnagramGame.prototype.generateWords = function(){
    this.avalilableWords = [];
    var allWords = wordsList.length;
    for(var i = 0; i < allWords; i++){
        var letterCount = 0;
        for(var j = 0; j < this.availableLetters.length; j++){
            if(wordsList[i].indexOf(this.availableLetters[j]) != -1){
                letterCount += 1;
            }
        }
        if(letterCount > 3){
